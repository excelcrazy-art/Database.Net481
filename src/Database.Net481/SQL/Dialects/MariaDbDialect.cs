...
namespace Database.Net481.SQL.Dialects
{
    ...
    public sealed class MariaDbDialect : ISqlDialect
    {
        ...
        public string QuoteIdentifier(string identifier)
        {
            ...
            // MariaDB에서는 ` 문자를 ``로 escape합니다.
            return "`" + identifier.Replace("`", "``") + "`";
        }

        /// <summary>
        /// MariaDB용 파라미터 이름을 반환합니다.
        /// </summary>
            ...
            IReadOnlyList<ColumnMetadata> primaryKeys)
        {
            ...
            {
                // MariaDB에서는 PK만 있는 경우에도
                // 자기 자신을 다시 대입하여 문법을 완성합니다.
                ColumnMetadata keyColumn = primaryKeys[0];
            ...
            else
            {
                for (int i = 0; i < updateColumns.Count; i++)
                {
                    ...
                    string columnName =
                        QuoteIdentifier(updateColumns[i].ColumnName);
